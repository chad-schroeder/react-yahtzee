...
class SmallStraight extends Rule {
  ...
  evalRoll = dice => {
    ...
    const first = d.has(1) && d.has(2) && d.has(3) && d.has(4);
    const second = d.has(2) && d.has(3) && d.has(4) && d.has(5);
    const third = d.has(3) && d.has(4) && d.has(5) && d.has(6);
    return first || second || third ? this.score : 0;
  };
}
